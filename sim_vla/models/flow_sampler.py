...
The online actor update is built on that fact rather than around it: it
differentiates the imagined return through the sampled action, which needs no
density at all. This sampler's transitions are deterministic and have none.
