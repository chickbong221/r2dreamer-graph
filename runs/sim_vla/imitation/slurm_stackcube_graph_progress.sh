#!/bin/bash
#SBATCH --job-name=r2d-svla-sc-gp-il
...
# the simulator. No online stage. Differs from slurm_stackcube_baseline.sh
...
echo "sim_vla: StackCube-v1, arm=graph_progress, imitation only (1A -> 1B -> eval)"
echo "================================="
...
# Keep in sync with slurm_stackcube_baseline.sh.
WORLD_STEPS=25000
...
OUT_DIR=$HOME/logdir/r2dreamer-graph/sim_vla/$TIMESTAMP/stackcube/graph_progress_imitation_seed${SEED}
echo "[out] $OUT_DIR"
