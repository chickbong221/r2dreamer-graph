#!/bin/bash
#SBATCH --job-name=r2d-svla-pi-gp-il
...
# the simulator. No online stage. Differs from slurm_peginsertion_baseline.sh
...
echo "sim_vla: PegInsertionSide-v1, arm=graph_progress, imitation only (1A -> 1B -> eval)"
echo "================================="
...
# Keep in sync with slurm_peginsertion_baseline.sh.
WORLD_STEPS=25000
...
OUT_DIR=$HOME/logdir/r2dreamer-graph/sim_vla/$TIMESTAMP/peginsertion/graph_progress_imitation_seed${SEED}
echo "[out] $OUT_DIR"
