#!/bin/bash
#SBATCH --job-name=r2d-svla-pc-gp-il
...
# the simulator. No online stage. Differs from slurm_pickcube_baseline.sh
...
echo "sim_vla: PickCube-v1, arm=graph_progress, imitation only (1A -> 1B -> eval)"
echo "================================="
...
OUT_DIR=$HOME/logdir/r2dreamer-graph/sim_vla/$TIMESTAMP/pickcube/graph_progress_imitation_seed${SEED}
echo "[out] $OUT_DIR"
