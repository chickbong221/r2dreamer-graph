#!/bin/bash
#SBATCH --job-name=r2d-svla-ps-bl-il
...
# the simulator. No online stage. Differs from slurm_placesphere_graph_progress.sh
...
echo "sim_vla: PlaceSphere-v1, arm=dreamer (baseline, no graph), imitation only (1A -> 1B -> eval)"
echo "================================="
...
OUT_DIR=$HOME/logdir/r2dreamer-graph/sim_vla/$TIMESTAMP/placesphere/dreamer_imitation_seed${SEED}
echo "[out] $OUT_DIR"
