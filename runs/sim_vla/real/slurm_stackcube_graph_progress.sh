#!/bin/bash
#SBATCH --job-name=r2d-svla-real-sc-gp
...
echo "sim_vla: SO-101 stackcube (real data), arm=graph_progress, imitation only (1A -> 1B)"
echo "================================="
...
OUT_DIR=$HOME/logdir/r2dreamer-graph/sim_vla/real/$TIMESTAMP/stackcube/graph_progress_seed${SEED}
echo "[out] $OUT_DIR"
