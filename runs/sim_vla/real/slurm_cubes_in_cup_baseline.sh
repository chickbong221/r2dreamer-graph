#!/bin/bash
#SBATCH --job-name=r2d-svla-real-cup-bl
...
# SO-101 cubes_in_cup (task 3, both cubes into the cup), arm=dreamer.
...
echo "sim_vla: SO-101 cubes_in_cup (real data), arm=dreamer, imitation only (1A -> 1B)"
echo "================================="
...
OUT_DIR=$HOME/logdir/r2dreamer-graph/sim_vla/real/$TIMESTAMP/cubes_in_cup/dreamer_seed${SEED}
echo "[out] $OUT_DIR"
