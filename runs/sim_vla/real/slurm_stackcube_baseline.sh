#!/bin/bash
#SBATCH --job-name=r2d-svla-real-sc-bl
...
# SO-101 stackcube (task 2, blue cube on red), arm=dreamer.
...
echo "sim_vla: SO-101 stackcube (real data), arm=dreamer, imitation only (1A -> 1B)"
echo "================================="
...
OUT_DIR=$HOME/logdir/r2dreamer-graph/sim_vla/real/$TIMESTAMP/stackcube/dreamer_seed${SEED}
echo "[out] $OUT_DIR"
