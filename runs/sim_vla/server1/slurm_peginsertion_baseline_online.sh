...
# Compared against slurm_peginsertion_graph_progress_online.sh, which differs by
...
echo "sim_vla: PegInsertionSide-v1, arm=dreamer, stage 2 only, actor=pathwise executed chunk"
echo "================================="
...
OUT_DIR=$HOME/logdir/r2dreamer-graph/sim_vla/$TIMESTAMP/peginsertion/dreamer_online_lr${ACTOR_LR}_seed${SEED}
echo "[out] $OUT_DIR"
